...
@Data
public class TaskReadByProjectResponse {
    private Long id;
    ...
    public static TaskReadByProjectResponse from(TaskReadByProjectResult result) {
        TaskReadByProjectResponse response = new TaskReadByProjectResponse();
    ...
    static class TaskPerformerResponse {
        ...
        public static TaskPerformerResponse from(TaskReadByProjectResult.TaskPerformerResult result) {
