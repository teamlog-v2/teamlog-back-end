...
@Data
public class ProjectReadAccountFollowingResult {
    private Long id;
    ...
    public static ProjectReadAccountFollowingResult from(Project project) {
        ProjectReadAccountFollowingResult response = new ProjectReadAccountFollowingResult();
